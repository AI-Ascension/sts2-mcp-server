...
- 2026-09-07: Record the Runtime-v4 expert source/component binding at MCP head
  ...
  correlation, instance, gateway session, lease/epoch, and operation identities; settled action
  observations bind nested `state_id`/`generation` to the outer response and
  `before_generation` to the dispatch generation. Copied schema IDs and digests are
