...
use crate::protocol_artifact_runtime_v2::RUNTIME_V2_ACTION_ID;
...
#[path = "mapping_runtime_v2_context.rs"]
mod context;

#[path = "mapping_runtime_v2_outcome.rs"]
mod outcome;
use context::{authority_headers, request_context};
use outcome::{gateway_error_result, uncertain_result};

const SUBMIT_ARGUMENTS: [&str; 8] = [
    "instance_id",
    "mcp_session_id",
    "lease_id",
    "lease_epoch",
...
const RECONCILE_ARGUMENTS: [&str; 7] = [
    "instance_id",
    "mcp_session_id",
    "lease_id",
    "lease_epoch",
